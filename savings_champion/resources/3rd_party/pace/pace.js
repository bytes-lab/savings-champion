...
(function() {
  ...
  Events = (function() {
    ...
    Events.prototype.trigger = function(name, val) {
      var binding, _j, _len1, _ref1, _results;
  ...
  shouldIgnoreURL = function(url) {
    var pattern, _j, _len1, _ref1;
    _ref1 = options.ajax.ignoreURLs;
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      pattern = _ref1[_j];
  ...
  getIntercept().on('request', function(_arg) {
    ...
    if (!Pace.running && (options.restartOnRequestAfter !== false || shouldTrack(type) === 'force')) {
      ...
      return setTimeout(function() {
        var stillActive, _j, _len1, _ref1, _ref2, _results;
        if (type === 'socket') {
  ...
  XHRRequestTracker = (function() {
    function XHRRequestTracker(request) {
      var event, size, _j, _len1, _onreadystatechange, _ref1;
      this.progress = 0;
  ...
  (init = function() {
    var type, _j, _k, _len1, _len2, _ref1, _ref2, _ref3;
  ...
  Pace.go = function() {
    ...
    return animation = runAnimation(function(frameTime, enqueueNextFrame) {
      var avg, count, done, element, elements, i, j, remaining, scaler, scalerList, sum, _j, _k, _len1, _len2, _ref1;
